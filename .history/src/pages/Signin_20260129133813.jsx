  ...
  return (
    <div className="min-h-screen bg-neutral-100 flex items-center justify-center px-5 py-8 text-neutral-900">
      <div className="w-full max-w-md bg-white rounded-3xl shadow-[0_14px_34px_rgba(0,0,0,0.08)] border border-black/5 px-8 py-10 sm:px-9">
        ...
        <button
          className="mt-5 mx-auto block w-fit text-[13px] font-bold text-gray-300 underline underline-offset-[6px] hover:text-gray-500 transition-colors duration-300"
          type="button"
        >
          회원가입
        </button>
        ...
        <div className="mt-11 flex items-center gap-3">
          ...
          <button
            type="button"
            className="h-12 min-w-[72px] px-5 rounded-2xl bg-black text-white font-[600] hover:bg-neutral-900 active:translate-y-[1px]"
          >
            확인
          </button>
        </div>
