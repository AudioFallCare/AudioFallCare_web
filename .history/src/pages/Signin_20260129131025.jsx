...
import EYESONME from "../../assets/Eye.png";
    ...
    <div className="min-h-screen bg-neutral-100 flex items-center justify-center px-5 py-8 text-neutral-900">
      <div className="w-full max-w-md bg-white rounded-3xl shadow-[0_14px_34px_rgba(0,0,0,0.08)] border border-black/5 px-8 py-10 sm:px-9">
        ...
        <div className="text-center mb-7">
          ...
          <h1 className="text-4xl font-extrabold tracking-tight leading-none">로그인</h1>
          <p className="mt-3 text-lg font-bold text-teal-400">실시간 낙상 감지 알리미</p>
        </div>
        ...
        <div className="mt-11 flex items-center gap-3">
          <input
            ...
            className="flex-1 h-12 px-5 rounded-2xl border border-gray-300 bg-white text-[15px] font-medium text-neutral-900 placeholder:text-gray-300 focus:outline-none focus:ring-4 focus:ring-indigo-500/15 focus:border-indigo-500/60"
          />
          <button
            type="button"
            className="h-12 min-w-[92px] px-5 rounded-2xl bg-black text-white font-bold hover:bg-neutral-900 active:translate-y-[1px]"
          >
            확인
          </button>
        </div>
